...
<?php if(is_array($data)): foreach($data as $key=>$v): ?><li class="<?php if(CONTROLLER_NAME == $v['name']): ?>active open<?php endif; ?>"><!--open代表打开状态-->
				...
				<div class="main-content-inner">
					<div class="page-content">
							...
							<div class="row maintop">
								...
								<a href="/index.php/Admin/Goods/admin_list_add">
								...
								<form name="admin_list_sea" class="form-search" method="post" action="/index.php/Admin/Goods/admin_list">
									<div class="input-group">
										<span class="input-group-addon">
											<i class="ace-icon fa fa-check"></i>
										</span>
										<input type="text" name="val" id="val" class="form-control search-query admin_sea" value="<?php echo ($testval); ?>" placeholder="请输入需查询的用户名" />
  ...
  <div class="input-group-btn">
  	<a href="/index.php/Admin/Goods/goods_list">
...
function del(id){
	...
	layer.close(index);
	window.location.href="/index.php/Admin/Goods/admin_list_del/admin_id/"+id+"";
	});
}
