                                ...
                                <input type="hidden" name="sys_id" value="<?php echo ($sys["sys_id"]); ?>" />
									<div class="form-group">
										...
										<div class="col-sm-9" style="padding-top:5px;">
											<input name="email_open" id="email_open" value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
											<span class="lbl"></span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="email_pwd" id="email_pwd" value="<?php echo ($sys["email_pwd"]); ?>"  class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
