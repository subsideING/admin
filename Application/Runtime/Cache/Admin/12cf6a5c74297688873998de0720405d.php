				...
				<div class="main-content-inner">
					...
					<div class="row maintop">
							<div class="col-xs-12 col-sm-2">
								<a href="/index.php/Admin/Goods/goodsAdd">
							...
							<div class="col-xs-12 col-sm-6">
								<form name="admin_list_sea" class="form-search" method="get" action="/index.php/Admin/Goods/lst">
											...
											<tbody>
												...
												<?php if(is_array($goods)): foreach($goods as $key=>$v): ?><tr>
														<td align="center">
															...
															<td>
																<img src="<?php echo ($v["sm_logo"]); ?>">
															</td>
				<td>
					<?php if($v[is_on_sale] == "是"): ?><a class="red" href="javascript:;" onclick="return stateyes(<?php echo ($v["id"]); ?>);" title="已开启">
...
$('#checkk').attr('value',1);
$('#leftnav').attr("action", "<?php echo U('goodsDel');?>");
});
...
function del(id){
	    ...
	    layer.close(index);
	    $.get("/index.php/Admin/Goods/goodsDel", {id : id}, function(data){
	    	if(data.status==1){
	    ...
	    //window.location.href="/index.php/Admin/Goods/goodsDel/n_id/"+id+"";
	});
}
